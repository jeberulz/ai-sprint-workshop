...
export default function Day3DeepDive() {
  ...
  const copyPrompt = async () => {
    const promptText = '"Create an MVP roadmap for a mobile app that prioritizes core user flows: user onboarding, main feature interaction, and basic profile management."'
    try {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7">
            <p className="text-sm uppercase text-blue-300/90 font-geist tracking-tighter">Day 3 Deep Dive</p>
            <h2 className="mt-2 text-3xl lg:text-4xl tracking-tight font-semibold font-geist" style={{fontFamily: '"Plus Jakarta Sans", Inter, sans-serif', fontWeight: 600}}>
              No‑Code Frontend Build & MVP Roadmap
            </h2>
            ...
            <div className="mt-6 space-y-4">
              <div>
                ...
                <ul className="mt-2 space-y-2">
                  <li className="flex items-start gap-3 font-geist tracking-tighter text-sm text-gray-300">
                    ...
                    We'll translate our AI‑generated designs into a pixel‑perfect, responsive frontend using Bubble.
                  </li>
                  <li className="flex items-start gap-3 font-geist tracking-tighter text-sm text-gray-300">
                    <span className="inline-flex h-6 w-6 items-center justify-center rounded-md bg-white/5 ring-1 ring-white/10 shrink-0">
                      <Rocket className="w-3.5 h-3.5 text-indigo-300" />
                    </span>
                    We'll focus on building the core features defined in our MVP Roadmap, ensuring we build what matters most, first.
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-lg border border-white/10 bg-black/40 p-4">
                ...
                <pre className="mt-2 text-[13px] leading-relaxed font-geist-mono text-gray-100 whitespace-pre-wrap">
                  "Create an MVP roadmap for a mobile app that prioritizes core user flows: user onboarding, main feature interaction, and basic profile management."
                </pre>
              </div>
            </div>
