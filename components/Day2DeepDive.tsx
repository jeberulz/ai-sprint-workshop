...
import { Target, FileText, Layout, ArrowRight, CalendarRange, Check, Zap, Copy, Play, Video } from 'lucide-react'
...
export default function Day2DeepDive() {
  ...
  return (
    <section ref={sectionRef} id="day2" className="bg-gray-950 pt-16 pb-16">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5">
              <div className="relative h-72 sm:h-80">
                {!isVideoPlaying ? (
                  ...
                  >
                    <source src="/videos/day2-product-specs-design.mp4" type="video/mp4" />
                    <source src="/videos/day2-product-specs-design.webm" type="video/webm" />
